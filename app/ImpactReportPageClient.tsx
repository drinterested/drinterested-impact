        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-[#4ecdc4]/10 text-[#405862] px-4 py-2 rounded-full text-sm font-medium mb-6">
              ...
              {activeTab === "annual" ? "2025 Annual Report • January 2026" : "2025 Semi-Annual Report • July 2025"}
            </div>

            <h1 className="text-4xl md:text-6xl font-bold text-[#405862] mb-6 leading-tight">
              {activeTab === "annual" ? "2025 Annual" : "2025 Semi-Annual"}
            ...
            <p className="text-lg md:text-xl text-gray-600 max-w-4xl mx-auto mb-8 leading-relaxed">
              {activeTab === "annual"
                ...
                : "Discover the measurable impact Dr. Interested has made in empowering high school students to explore healthcare careers through comprehensive education, mentorship programs, and hands-on experiences. This report covers our achievements from January 2025 through June 2025."}
            </p>

            {/* Key Impact Metrics */}
            <div className={`grid ${activeTab === "annual" ? "md:grid-cols-3 lg:grid-cols-6" : "grid-cols-2 md:grid-cols-4"} gap-4 md:gap-6 max-w-6xl mx-auto mb-8`}>
              {activeTab === "annual" ? (
                <>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 text-sm text-gray-600 mb-12">
              <div className="flex items-center gap-2">
                ...
                {activeTab === "annual" ? "January 7, 2025 - January 7, 2026" : "January - June 2025"}
              </div>
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 bg-[#405862] rounded-full"></div>
                <span className="font-medium">Published:</span> {activeTab === "annual" ? "January 2026" : "July 2025"}
              </div>
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 bg-[#4ecdc4] rounded-full"></div>
                <span className="font-medium">Report Type:</span> {activeTab === "annual" ? "Annual Assessment" : "Semi-Annual Assessment"}
              </div>
            </div>
            ...
            <div className="flex justify-center mb-8">
              <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full max-w-md">
                <TabsList className="grid w-full grid-cols-2 bg-white border border-[#405862]/20">
                  <TabsTrigger
                    value="annual"
                    className="data-[state=active]:bg-[#4ecdc4] data-[state=active]:text-white text-[#405862] hover:bg-[#4ecdc4]/10 transition-colors"
                  >
                    2025 Annual
                  </TabsTrigger>
                  <TabsTrigger
                ...
                <>
                  ...
                  >
                    <iframe
                      ...
                      aria-label="Interactive semi-annual impact report showing Dr. Interested's achievements in healthcare education"
                    />
                  </div>

                  {/* Semi-Annual Report Attribution and Actions */}
                  <div className="bg-gray-50 rounded-lg p-6 mt-6">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                      <div className="text-center md:text-left">
                        <h3 className="font-semibold text-[#405862] mb-1">
