...
export default function SemiAnnualReportClient() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <p className="text-lg md:text-xl mb-8 opacity-90 leading-relaxed">
              Be part of our growing community impacting students across 65+ countries. Together, we're building a more diverse,
              accessible, and impactful pathway into healthcare careers for the next generation of healthcare professionals
              worldwide.
            </p>
